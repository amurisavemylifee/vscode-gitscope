...
в любых двух точках истории: выбираете две ревизии и видите, чем отличается дерево
файлов, как во вкладке «Files changed» у pull request.
...
Сравнения с рабочим деревом, индексом и стешем (только коммиты, ветки и теги);
отметок «просмотрено»; комментариев; захода внутрь подмодулей; просмотра картинок
(двоичные файлы показываются размерами); визуального графа коммитов.
